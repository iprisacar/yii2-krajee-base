...
trait BootstrapTrait
{
    ...
    public static $bsCssMap = [
        ActiveForm::BS_SR_ONLY => ['sr-only', 'sr-only', 'visually-hidden'],
        ActiveForm::BS_PANEL => ['panel', 'card'],
        ActiveForm::BS_PANEL_HEADING => ['panel-heading', 'card-header'],
        ActiveForm::BS_PANEL_TITLE => ['panel-title', 'card-title'],
        ActiveForm::BS_PANEL_BODY => ['panel-body', 'card-body'],
        ActiveForm::BS_PANEL_FOOTER => ['panel-footer', 'card-footer'],
        ActiveForm::BS_PANEL_DEFAULT => ['panel-default', ['bg-light', 'text-dark']],
        ActiveForm::BS_PANEL_DARK => ['panel-default', ['bg-dark', 'text-white']],
        ActiveForm::BS_PANEL_SECONDARY => ['panel-default', ['bg-secondary', 'text-white']],
        ActiveForm::BS_PANEL_PRIMARY => ['panel-primary', ['bg-primary', 'text-white']],
        ActiveForm::BS_PANEL_SUCCESS => ['panel-success', ['bg-success', 'text-white']],
        ActiveForm::BS_PANEL_INFO => ['panel-info', ['bg-info', 'text-dark']],
        ActiveForm::BS_PANEL_WARNING => ['panel-warning', ['bg-warning', 'text-dark']],
        ActiveForm::BS_PANEL_DANGER => ['panel-danger', ['bg-danger', 'text-white']],
        ActiveForm::BS_LABEL => ['label', 'badge'],
        ActiveForm::BS_BADGE => ['badge', ['badge', 'badge-pill'], ['badge', 'rounded-pill']],
        ActiveForm::BS_LABEL_DEFAULT => ['label-default', 'badge-secondary', 'bg-secondary'],
        ActiveForm::BS_LABEL_LIGHT => ['label-default', ['bg-light', 'text-dark']],
        ActiveForm::BS_LABEL_DARK => ['label-default', ['bg-dark', 'text-white']],
        ActiveForm::BS_LABEL_PRIMARY => ['label-primary', 'badge-primary', 'bg-primary'],
        ActiveForm::BS_LABEL_SUCCESS => ['label-success', 'badge-success', 'bg-success'],
        ActiveForm::BS_LABEL_INFO => ['label-info', 'badge-info', ['bg-info', 'text-dark']],
        ActiveForm::BS_LABEL_WARNING => ['label-warning', 'badge-warning', ['bg-warning', 'text-dark']],
        ActiveForm::BS_LABEL_DANGER => ['label-danger', 'badge-danger', 'bg-danger'],
        ActiveForm::BS_TABLE_ACTIVE => ['default', 'table-active'],
        ActiveForm::BS_TABLE_PRIMARY => ['primary', 'table-primary'],
        ActiveForm::BS_TABLE_SUCCESS => ['success', 'table-success'],
        ActiveForm::BS_TABLE_INFO => ['info', 'table-info'],
        ActiveForm::BS_TABLE_WARNING => ['warning', 'table-warning'],
        ActiveForm::BS_TABLE_DANGER => ['danger', 'table-danger'],
        ActiveForm::BS_PROGRESS_BAR_ACTIVE => ['active', 'progress-bar-animated'],
        ActiveForm::BS_PROGRESS_BAR_PRIMARY => ['progress-bar-primary', 'bg-primary'],
        ActiveForm::BS_PROGRESS_BAR_SUCCESS => ['progress-bar-success', 'bg-success'],
        ActiveForm::BS_PROGRESS_BAR_INFO => ['progress-bar-info', 'bg-info'],
        ActiveForm::BS_PROGRESS_BAR_WARNING => ['progress-bar-warning', 'bg-warning'],
        ActiveForm::BS_PROGRESS_BAR_DANGER => ['progress-bar-danger', 'bg-danger'],
        ActiveForm::BS_WELL => ['well', ['card', 'card-body']],
        ActiveForm::BS_WELL_SM => ['well-sm', ['card', 'card-body', 'p-2']],
        ActiveForm::BS_WELL_LG => ['well-lg', ['card', 'card-body', 'p-4']],
        ActiveForm::BS_THUMBNAIL => ['thumbnail', ['card', 'card-body']],
        ActiveForm::BS_NAVBAR_DEFAULT => ['navbar-default', 'navbar-light'],
        ActiveForm::BS_NAVBAR_TOGGLE => ['navbar-toggle', 'navbar-toggler'],
        ActiveForm::BS_NAVBAR_RIGHT => ['navbar-right', 'ml-auto'],
        ActiveForm::BS_NAVBAR_BTN => ['navbar-btn', 'nav-item'],
        ActiveForm::BS_NAVBAR_FIXTOP => ['navbar-fixed-top', 'fixed-top'],
        ActiveForm::BS_NAV_STACKED => ['nav-stacked', 'flex-column'],
        ActiveForm::BS_NAV_ITEM => ['', 'nav-item'],
        ActiveForm::BS_NAV_LINK => ['', 'nav-link'],
        ActiveForm::BS_PAGE_ITEM => ['', 'page-item'],
        ActiveForm::BS_PAGE_LINK => ['', 'page-link'],
        ActiveForm::BS_LIST_INLINE_ITEM => ['', 'list-inline-item'],
        ActiveForm::BS_BTN_DEFAULT => ['btn-default', 'btn-secondary'],
        ActiveForm::BS_IMG_RESPONSIVE => ['img-responsive', 'img-fluid'],
        ActiveForm::BS_IMG_CIRCLE => ['img-circle', 'rounded-circle'],
        ActiveForm::BS_IMG_ROUNDED => ['img-rounded', 'rounded'],
        ActiveForm::BS_RADIO => ['radio', 'form-check'],
        ActiveForm::BS_CHECKBOX => ['checkbox', 'form-check'],
        ActiveForm::BS_INPUT_LG => ['input-lg', 'form-control-lg'],
        ActiveForm::BS_INPUT_SM => ['input-sm', 'form-control-sm'],
        ActiveForm::BS_CONTROL_LABEL => ['control-label', 'col-form-label'],
        ActiveForm::BS_TABLE_CONDENSED => ['table-condensed', 'table-sm'],
        ActiveForm::BS_CAROUSEL_ITEM => ['item', 'carousel-item'],
        ActiveForm::BS_CAROUSEL_ITEM_NEXT => ['next', 'carousel-item-next'],
        ActiveForm::BS_CAROUSEL_ITEM_PREV => ['prev', 'carousel-item-prev'],
        ActiveForm::BS_CAROUSEL_ITEM_LEFT => ['left', 'carousel-item-left'],
        ActiveForm::BS_CAROUSEL_ITEM_RIGHT => ['right', 'carousel-item-right'],
        ActiveForm::BS_CAROUSEL_CONTROL_LEFT => [['carousel-control', 'left'], 'carousel-control-left'],
        ActiveForm::BS_CAROUSEL_CONTROL_RIGHT => [['carousel-control', 'right'], 'carousel-control-right'],
        ActiveForm::BS_HELP_BLOCK => ['help-block', 'form-text'],
        ActiveForm::BS_PULL_RIGHT => ['pull-right', 'float-right', 'float-end'],
        ActiveForm::BS_PULL_LEFT => ['pull-left', 'float-left', 'float-start'],
        ActiveForm::BS_CENTER_BLOCK => ['center-block', ['mx-auto', 'd-block']],
        ActiveForm::BS_HIDE => ['hide', 'd-none'],
        ActiveForm::BS_HIDDEN_PRINT => ['hidden-print', 'd-print-none'],
        ActiveForm::BS_HIDDEN_XS => ['hidden-xs', ['d-none', 'd-sm-block']],
        ActiveForm::BS_HIDDEN_SM => ['hidden-sm', ['d-sm-none', 'd-md-block']],
        ActiveForm::BS_HIDDEN_MD => ['hidden-md', ['d-md-none', 'd-lg-block']],
        ActiveForm::BS_HIDDEN_LG => ['hidden-lg', ['d-lg-none', 'd-xl-block']],
        ActiveForm::BS_VISIBLE_PRINT => ['visible-print-block', ['d-print-block', 'd-none']],
        ActiveForm::BS_VISIBLE_XS => ['visible-xs', ['d-block', 'd-sm-none']],
        ActiveForm::BS_VISIBLE_SM => ['visible-sm', ['d-none', 'd-sm-block', 'd-md-none']],
        ActiveForm::BS_VISIBLE_MD => ['visible-md', ['d-none', 'd-md-block', 'd-lg-none']],
        ActiveForm::BS_VISIBLE_LG => ['visible-md', ['d-none', 'd-lg-block', 'd-xl-none']],
        ActiveForm::BS_FORM_CONTROL_STATIC => ['form-control-static', 'form-control-plaintext'],
        ActiveForm::BS_DROPDOWN_DIVIDER => ['divider', 'dropdown-divider'],
        ActiveForm::BS_SHOW => ['in', 'show'],
    ];
